				...
				if (!usi_app.suppress_page) {
					...
					if(document.querySelector('.mui-b7eh1n-actionsConversionContainer .mui-nd8umf-root-offsetRibbon') != null) {
						if(usi_app.is_enabled) {
							...
							usi_commons.log('[usi] Suppressing due to being on a premium content page')
							return
						}
					}
					...
					if(usi_app.is_enabled && (usi_app.is_premium_in_cart || usi_cookies.value_exists('usi_cart_contains_premium') || premium_content_detected)) {
